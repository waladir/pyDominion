...
{ 'Zhroucení velikosti' : { 'expansions' : ['Dominion'], 'cards' : ['Witch', 'Workshop', 'Woodcutter', 'Feast', 'Chapel', 'Laboratory', 'Cellar', 'Village', 'Gardens', 'Thief'] }},
{ 'Náves' : { 'expansions' : ['Dominion'], 'cards' : ['Woodcutter', 'Festival', 'Library', 'Smithy', 'Remodel', 'Cellar', 'Market', 'Throne_Room', 'Bureaucrat', 'Village'] }},

{ 'Vítězný tanec' : { 'expansions' : ['Intrigue'], 'cards' : ['Bridge', 'Duke', 'Great_Hall', 'Harem', 'Ironworks', 'Masquerade', 'Nobles', 'Pawn', 'Scout', 'Upgrade'] }},
...
{ 'Pokrok' : { 'expansions' : ['Dominion2nd'], 'cards' : ['Artisan', 'Cellar', 'Market', 'Merchant', 'Mine', 'Moat', 'Moneylender', 'Poacher', 'Remodel', 'Witch'] }},
{ 'Stříbro & zlato' : { 'expansions' : ['Dominion2nd'], 'cards' : ['Bandit', 'Bureaucrat', 'Chapel', 'Harbinger', 'Laboratory', 'Merchant', 'Mine', 'Moneylender', 'Throne_Room', 'Vassal'] }},

{ 'Demontáž' : { 'expansions' : ['Dominion', 'Intrigue'], 'cards' : ['Bridge', 'Mining_Village', 'Remodel', 'Saboteur', 'Secret_Chamber', 'Spy', 'Swindler', 'Thief', 'Trhone_Room', 'Torturer'] }},
{ 'Plná ruka' : { 'expansions' : ['Dominion', 'Intrigue'], 'cards' : ['Bureaucrat', 'Chancellor', 'Council_Room', 'Courtyard', 'Mine', 'Militia', 'Minion', 'Nobles', 'Steward', 'Torturer'] }},
{ 'Poddaný' : { 'expansions' : ['Dominion', 'Intrigue'], 'cards' : ['Baron', 'Cellar', 'Festival', 'Library', 'Masquerade', 'Minion', 'Nobles', 'Pawn', 'Steward', 'Witch'] }},

{ 'Poddaní' : { 'expansions' : ['Dominion2nd', 'Intrigue2nd'], 'cards' : ['Cellar', 'Festival', 'Library', 'Sentry', 'Vassal', 'Courtier', 'Diplomat', 'Minion', 'Nobles', 'Pawn'] }},
{ 'Velký plán' : { 'expansions' : ['Dominion2nd', 'Intrigue2nd'], 'cards' : ['Artisan', 'Council_Room', 'Market', 'Militia', 'Workshop', 'Bridge', 'Mill', 'Minning_Village', 'Patrol', 'Shanty_Town'] }},
{ 'Destrukce' : { 'expansions' : ['Dominion2nd', 'Intrigue2nd'], 'cards' : ['Bandit', 'Mine', 'Remodel', 'Throne_Room', 'Village', 'Diplomat', 'Harem', 'Lurker', 'Replace', 'Swindler'] }}
